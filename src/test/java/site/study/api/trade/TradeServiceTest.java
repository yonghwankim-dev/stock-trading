...
import site.stocktrading.api.trade.service.TradeException;
...
class TradeServiceTest {
	...
	@DisplayName("종목과 수량이 주어지고 수량이 0인 경우에 예외를 전파한다")
	@Test
	void givenStockAndQuantity_whenBuyStockWithNotEnoughQuantity_thenSpreadException() {
		// given
		Stock samsung = new Stock("samsung", 50000);
		int quantity = 0;
		// when
